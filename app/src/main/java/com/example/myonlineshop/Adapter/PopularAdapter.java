...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull PopularAdapter.Viewholder holder, int position) {
        holder.binding.popularTitleTV.setText(items.get(position).getTitle());
        holder.binding.reviewTV.setText(""+items.get(position).getReview());
        holder.binding.newPriceTV.setText("$"+items.get(position).getPrice());
        holder.binding.ratingTV.setText("("+items.get(position).getRating()+")");
        holder.binding.oldPriceTV.setText("$"+items.get(position).getOldPrice());
        holder.binding.oldPriceTV.setPaintFlags(holder.binding.oldPriceTV.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
